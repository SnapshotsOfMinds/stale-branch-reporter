...
public final class I18NMessageUtility {
  ...
  /**
   * Constructor to create a I18NMessageUtility object. The {@code clazz} value is read from the call
   * stack within this constructor.
   */
   ...
   * @return The formatted string of the original message. If the value obtained from the file is
  ...
  /**
   * Returns the message, with it's variables replaced, from the properties file. This method uses the
   * default {@link Locale} while performing the lookup.
   *
   * @param key The key used to lookup the message.
   * @param values The array of values used to populate variables in the message.
   * @return The formatted string of the original message. If the value obtained from the file is
